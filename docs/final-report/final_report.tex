...
\begin{titlepage}
    \begin{figure}[!h]
        \centering
        \includegraphics[width=.2\textwidth]{../Project Report/images/iut_logo.png}
    \end{figure}
    \begin{center}
...
\begin{figure}[!h]
    \centering
    % \includegraphics[width=0.6\linewidth]{images/FlowchartPlaceholder.png}
