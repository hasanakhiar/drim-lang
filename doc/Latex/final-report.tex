...
\begin{itemize}
    ...
    \item \textbf{Custom Syntax:} Uses unique keywords like \texttt{drimming} for loops and \texttt{wake} for output to match the project's theme.
    ...
    \item \textbf{Output Formatting:} Provides options for formatted output, including support for newlines (\texttt{wakef()} vs \texttt{wake()}) within strings.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Created basic input and output systems and basic architecture of lexer, parser, and interpreter with Error Reporting.
    ...
    \begin{itemize}
        ...
        \item Implemented String Interpolation and Output Formatting.
    \end{itemize}
